...
c0.Update()
pt_projy = histPartVsPT.ProjectionY("projectionY", histPartVsPT.GetBin(200,0), histPartVsPT.GetBin(250,0) )
pt_projy.Draw("colz")
c0.Print("../FragmentationStudy/plots/"+sys.argv[2]+"_PartVsPTprojY.png")
c0.Clear()

c0.Update()
pt_projyg = histPartVsPTg.ProjectionY("projectionYg", 0, 10 )
pt_projyg.Draw("colz")
