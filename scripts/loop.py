...
myfile = ROOT.TFile.Open(sys.argv[2]+"_histograms.root", "RECREATE")
...
print("Found {} events.".format(numberOfEntries))
exit(0)
...
h_n50_p = ROOT.TH2D("h_n50_p","; Jet P; n50",10,0,250,100,0,10)
h_n80_p = ROOT.TH2D("h_n80_p","; Jet P; n80",10,0,250,100,0,20)
h_n90_p = ROOT.TH2D("h_n90_p","; Jet P; n90",10,0,250,100,0,30)
h_n95_p = ROOT.TH2D("h_n95_p","; Jet P; n95",10,0,250,100,0,30)
h_n99_p = ROOT.TH2D("h_n99_p","; Jet P; n99",10,0,250,100,0,30)
...
for entry, event in enumerate(jetconst_refs[:]):
    ...
    doprint = entry%1000==0 #entry<=5

    if doprint: print("Event #{} has {} jet(s)".format(entry, branchGenJet.GetEntries()))
    ...
    for ijet in range(branchGenJet.GetEntries()):
        ...
        if doprint: print(const_indices)
...
c0.Update()
histGenJetP.Draw()
c0.Print("plots/"+sys.argv[2]+"_GenJetP.png")
c0.Clear()

c0.Update()
histGenJetPT.Draw()
c0.Print("plots/"+sys.argv[2]+"_GenJetPT.png")
c0.Clear()

c0.Update()
histGenJetM.Draw()
c0.Print("plots/"+sys.argv[2]+"_GenJetMass.png")
c0.Clear()

c0.Update()
h_n50_p.Draw()
c0.Print("plots/"+sys.argv[2]+"_h_n50_p.png")
c0.Clear()

c0.Update()
h_n80_p.Draw()
c0.Print("plots/"+sys.argv[2]+"_h_n80_p.png")
c0.Clear()

c0.Update()
h_n90_p.Draw()
c0.Print("plots/"+sys.argv[2]+"_h_n90_p.png")
c0.Clear()

c0.Update()
h_n95_p.Draw()
c0.Print("plots/"+sys.argv[2]+"_h_n95_p.png")
c0.Clear()

c0.Update()
h_n99_p.Draw()
c0.Print("plots/"+sys.argv[2]+"_h_n99_p.png")
c0.Clear()
...
profx.Draw()
c0.Print("plots/"+sys.argv[2]+"_PartVsPprofx.png")
histPartVsP.Draw("colz")
c0.Print("plots/"+sys.argv[2]+"_PartVsP.png")
c0.Clear()
...
pt_profx.Draw()
c0.Print("plots/"+sys.argv[2]+"_PartVsPTprofx.png")
histPartVsPT.Draw("colz")
c0.Print("plots/"+sys.argv[2]+"_PartVsPT.png")
c0.Clear()
