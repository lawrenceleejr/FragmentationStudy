...
def shared_plot(file_name1, name1, text1, file_name2, name2,text2, nxx,ylim1,ylim2,xlim):
    ...
    #plt.show()
    pickle.dump(fig,open('saved_fig.pickle','wb'))
    pickle.dump(ax1,open('saved_ax1.pickle','wb'))
    pickle.dump(ax2,open('saved_ax2.pickle','wb'))
    #plt.savefig('plot_images/squished_'+ file_name1+"_v_"+file_name2 + '_'+"n"+str(nxx)+'.pdf',format="pdf", bbox_inches="tight")
    #plt.close()

shared_plot("eeToJJJ_50k_1TeV","JJJ","ee \u27F6 3j","eeToZZToJJ_50k_1TeV","ZZ","ee \u27F6 ZZ \u27F6 4j",90,16,9.9,3.5)
