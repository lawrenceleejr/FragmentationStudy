...
def split_violin(file_name1, name1, text1, file_name2, name2,text2, nxx,ylim):
    file1 = uproot.open("./violin_files/" + file_name1+ "_histograms.root")
    file2 = uproot.open("./violin_files/" + file_name2+ "_histograms.root")
    ...
    plt.savefig('split_plots/'+ file_name1+"_v_"+file_name2 + '_'+"n"+str(nxx)+'.png')
    plt.close()
